...
outFileGain <- "mapped-scenario3-OV-gain-candidates.txt"
outFileLoss <- "mapped-scenario3-OV-loss-candidates.txt"
...
filteredListGain <- lapply(names(ccFilteredGain), function(x){
